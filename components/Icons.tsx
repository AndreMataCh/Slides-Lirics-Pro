...
export const ProjectorIcon: React.FC = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-sky-400">
        <path d="M5 7 3 5"/><path d="m19 7 2-2"/><path d="M2 13h20"/><path d="M22 13v6a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2v-6"/><path d="m12 13-2-2-2 3h8l-2-3-2 2Z"/><circle cx="12" cy="7" r="4"/>
    </svg>
);
